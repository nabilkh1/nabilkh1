...
class ExampleTweets{
    ...
    String Test1= this.Example1.toText();//"Stephen Curry @StephenCurry30"
    String Test2 = this.Example2.toText();//"Elon Musk @elonmusk"
    ...
    boolean LikeComparison1= this.Sample4.moreLikes(this.Sample3);//should be false
    boolean LikeComparison2= this.Sample2.moreLikes(this.Sample1);//should be true

    String ExampleText1 = this.Sample1.toText();//should be "NFL @NFL: Cardinals activate DE J.J. Watt off IR. : 15500 Likes"
    String ExampleText2=this.Sample2.toText();//should be "Elon Musk @elonmusk: Good thing I never tweet anything controversial : 233500 Likes"

    String ExmapleToLink1= this.Sample1.toLink();// should be  "http://twitter.com/NFL/status/1483183628414853126"
    String ExampleToLink2= this.Sample4.toLink();//should be  "http://twitter.com/NFL/status/1483183628414853126"
}